...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        if (o.getClass() == this.getClass()) {
            ...
            int b = compare.blue;
            int g = compare.green;
            return r == this.red && b == this.blue && g == this.green;
        }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            //return red * (int) Math.pow(255, 2) + green * 255 + blue;
        }
    }
    ...
    public static void main(String[] args) {
        SimpleOomage a = new SimpleOomage(5, 10, 25);
        SimpleOomage b = new SimpleOomage(5, 10, 25);
        a.equals(b);
